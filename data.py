import pandas as pd
file_name = 'MONTHLY RECEIVE FORMAT-24-25 - AUG-24.csv'
...
df = df[['SCHOOL NAME','CATEGORY NAME', 'DAYS',  'PP MEAL', 'PRI MEAL','V MEAL', 'UPPRI MEAL','PP_ALLOT', 'I_IV ALLOT','V ALLOT','EXPEN PP', 'EXPEN PRI','EXPEN V',
         'PP_R_ALLOT', 'I-IV_R_ALLOT', 'V_R_ALLOT',  'PP-RICE-EXPEN','PRI-RICE-EXPEN','V -RICE-EXPEN', 'CCH', 'IFA BOYS','IFA GIRLS']]
# df = df.fillna(0)
convert_dict = {'DAYS': 'Int64', 'PP MEAL': 'Int64', 'PRI MEAL':'Int64', 'V MEAL': 'Int64', 'UPPRI MEAL': 'Int64','PP_ALLOT': 'Int64', 'I_IV ALLOT': 'Int64',
                'V ALLOT':'Int64','PP_R_ALLOT':'float','I-IV_R_ALLOT':'float', 'V_R_ALLOT':'float', 'PP-RICE-EXPEN':'float','PRI-RICE-EXPEN':'float','V -RICE-EXPEN': 'float',
                    'CCH': 'Int64', 'IFA BOYS':'Int64','IFA GIRLS':'Int64'}
...
def call_the_data(no):
    start = no-1
    db_process = df_filtered.iloc[no:, :]
